      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            A comprehensive Next.js 14 application showcasing modern data fetching strategies, 
            TypeScript integration, accessibility best practices, and clean component architecture.
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Multiple strategies implemented with detailed trade-off analysis
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Navigate through the application to see different data fetching strategies in action, 
            from server-side rendering to client-side caching with SWR.
          </p>
